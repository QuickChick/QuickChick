...
let declare_class_instance ?(global=true) ?(priority=42) ~ontop instance_arguments instance_name instance_type instance_record =
  ...
  let cid, pstate = Classes.new_instance ~ontop ~global:global false
