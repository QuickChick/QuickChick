...
Notation " 'freq' [ x ; y ] " :=
  (freq' x.2 (cons (fun (_:unit) => x) (cons (fun (_ : unit) => y) nil))) : qc_scope.
Notation " 'freq' [ x ; y ; .. ; z ] " :=
  (freq' x.2 (cons (fun (_:unit) => x) (cons (fun (_: unit) => y) .. (cons (fun (_:unit) => z) nil) ..))) : qc_scope.
Notation " 'freq' ( x ;; l ) " :=
  (freq' x.2 (cons (fun (_: unit) => x) l)) (at level 1, no associativity) : qc_scope.
