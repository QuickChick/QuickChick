...
QCDerive ArbitrarySizedSuchThat for (fun t => bal n t).
QCDerive DecOpt for (bal n t).
QCDerive EnumSizedSuchThat for (fun n => bal n t).
...
QCDerive ArbitrarySizedSuchThat for (fun t => bstbal a b c t).
